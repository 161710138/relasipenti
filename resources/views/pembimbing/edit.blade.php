		...
		<div class="col-md-12">
			<div class="panel panel-primary">
			  ...
			  <div class="panel-body">
			  	<form action="{{ route('pembimbings.update',$a->id) }}" method="post" >
			  		<input name="_method" type="hidden" value="PATCH">
        			{{ csrf_field() }}
			  		<div class="form-group {{ $errors->has('Nama_pembimbing') ? ' has-error' : '' }}">
			  			<label class="control-label">Nama Pembimbing</label>	
			  			<input type="text" name="Nama_pembimbing" class="form-control" value="{{ $a->Nama_pembimbing }}"  required>
			  	...
			  	<div class="form-group {{$errors->has('Jenis_kelamin') ? 'has error' : '' }}">
			  		...
			  		<div class="form-group {{ $errors->has('Tempat_lahir') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="Tempat_lahir" class="form-control" value="{{ $a->Tempat_lahir }}"  required>
